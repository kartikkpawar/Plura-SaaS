...
import { pricingCards } from "@/lib/constansts";
...
export default function Home() {
  return (
    <Fragment>
      <section className="h-full w-full md:pt-44 lg:pt-96 mt-[-70px] relative flex items-center justify-center flex-col ">
      ...
      <section className="flex justify-center flex-col gap-4 items-center lg:mt-64 md:mt-20 mt-[-60px]">
